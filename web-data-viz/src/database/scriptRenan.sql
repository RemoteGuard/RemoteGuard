...
('assistente', 'Fernanda Lima', '12345678906', 'fernanda.lima@empresa.com', 'senha123', 1, 6);
 ...
 insert into dados values (default, 5, 100.0, 100.0, 100, 20.0, 100, 50.0, "joao", default);
...
select fkNotebook as idNotebook from funcionario where funcionario.nome = "Lucas Pereira";
