...
function ultimosDados() {
  ...
  var instrucaoSql = `SELECT 
    ...
    dados 
    JOIN 
    notebook ON dados.fkNotebook = notebook.idNotebook  -- Relaciona dados com notebook
    JOIN 
    funcionario ON notebook.idNotebook = funcionario.idFuncionario  -- Relaciona notebook com funcionários
    ORDER BY 
